# INC-10114 — Proxy configuration blocks site

## Summary
- Priority: P4
- Category: Networking & VPN
- Requester: User-049
- Assigned technician: Tech-02
- SLA result: Met
- Resolution time: 1060 minutes
...
2. Reproduced or validated the reported symptom: proxy configuration blocks site.
...
## Root cause
Connectivity or name resolution. The condition was limited to the affected user or endpoint and was not caused by a confirmed enterprise outage.
