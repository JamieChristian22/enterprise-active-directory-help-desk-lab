# INC-10031 — Account lockout after password change
...
2. Reproduced or validated the reported symptom: account lockout after password change.
...
## Root cause
Identity configuration. The condition was limited to the affected user or endpoint and was not caused by a confirmed enterprise outage.
