# INC-10010 — NTFS permission mismatch
...
2. Reproduced or validated the reported symptom: ntfs permission mismatch.
...
## Root cause
Permission or storage state. The condition was limited to the affected user or endpoint and was not caused by a confirmed enterprise outage.
