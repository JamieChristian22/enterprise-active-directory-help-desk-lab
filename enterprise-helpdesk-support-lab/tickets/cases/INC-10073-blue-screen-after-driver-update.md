# INC-10073 — Blue screen after driver update
...
2. Reproduced or validated the reported symptom: blue screen after driver update.
...
## Root cause
OS or driver state. The condition was limited to the affected user or endpoint and was not caused by a confirmed enterprise outage.
