# INC-10078 — Browser certificate warning
...
2. Reproduced or validated the reported symptom: browser certificate warning.
...
## Root cause
Security control or user action. The condition was limited to the affected user or endpoint and was not caused by a confirmed enterprise outage.
