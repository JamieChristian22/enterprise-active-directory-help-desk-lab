# Runbook: Storage Capacity Threshold Breach

## Purpose
Restore service safely and consistently during a **Storage capacity threshold breach** while preserving evidence and meeting incident, security, and change-control requirements.
