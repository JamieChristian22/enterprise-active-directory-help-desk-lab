# Runbook: Linux High-Load Alert

## Purpose
Restore service safely and consistently during a **Linux high-load alert** while preserving evidence and meeting incident, security, and change-control requirements.
