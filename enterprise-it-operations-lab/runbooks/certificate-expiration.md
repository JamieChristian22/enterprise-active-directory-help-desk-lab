...
## Purpose
Restore service safely and consistently during a **Certificate expiration response** while preserving evidence and meeting incident, security, and change-control requirements.
