# Runbook: Suspected Aws Access-Key Exposure

## Purpose
Restore service safely and consistently during a **Suspected AWS access-key exposure** while preserving evidence and meeting incident, security, and change-control requirements.
