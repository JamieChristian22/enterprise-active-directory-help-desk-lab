# Runbook: Entra Connect Synchronization Failure

## Purpose
Restore service safely and consistently during a **Entra Connect synchronization failure** while preserving evidence and meeting incident, security, and change-control requirements.
