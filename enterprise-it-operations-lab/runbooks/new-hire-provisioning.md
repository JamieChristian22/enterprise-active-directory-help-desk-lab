# Runbook: New-Hire Provisioning

## Purpose
Restore service safely and consistently during a **New-hire provisioning** while preserving evidence and meeting incident, security, and change-control requirements.
