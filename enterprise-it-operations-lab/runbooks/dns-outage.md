# Runbook: Dns Service Outage

## Purpose
Restore service safely and consistently during a **DNS service outage** while preserving evidence and meeting incident, security, and change-control requirements.
