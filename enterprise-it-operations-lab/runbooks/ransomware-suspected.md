# Runbook: Suspected Ransomware Containment

## Purpose
Restore service safely and consistently during a **Suspected ransomware containment** while preserving evidence and meeting incident, security, and change-control requirements.
