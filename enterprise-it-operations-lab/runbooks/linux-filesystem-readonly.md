# Runbook: Linux Filesystem Read-Only Event

## Purpose
Restore service safely and consistently during a **Linux filesystem read-only event** while preserving evidence and meeting incident, security, and change-control requirements.
