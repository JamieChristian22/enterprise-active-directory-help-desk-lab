# Runbook: Site Print Service Outage

## Purpose
Restore service safely and consistently during a **Site print service outage** while preserving evidence and meeting incident, security, and change-control requirements.
