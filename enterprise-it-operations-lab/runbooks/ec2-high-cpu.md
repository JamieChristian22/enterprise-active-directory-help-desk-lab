# Runbook: Aws Ec2 Sustained High Cpu

## Purpose
Restore service safely and consistently during a **AWS EC2 sustained high CPU** while preserving evidence and meeting incident, security, and change-control requirements.
