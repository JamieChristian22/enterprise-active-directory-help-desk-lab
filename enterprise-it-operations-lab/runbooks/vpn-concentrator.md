# Runbook: Vpn Concentrator Degradation

## Purpose
Restore service safely and consistently during a **VPN concentrator degradation** while preserving evidence and meeting incident, security, and change-control requirements.
