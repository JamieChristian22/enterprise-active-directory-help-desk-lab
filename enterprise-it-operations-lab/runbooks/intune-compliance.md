# Runbook: Intune Compliance Policy Failure

## Purpose
Restore service safely and consistently during a **Intune compliance policy failure** while preserving evidence and meeting incident, security, and change-control requirements.
