# Runbook: Monitoring Agent Offline

## Purpose
Restore service safely and consistently during a **Monitoring agent offline** while preserving evidence and meeting incident, security, and change-control requirements.
