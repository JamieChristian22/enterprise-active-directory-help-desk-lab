# Runbook: Windows Patch Deployment Failure

## Purpose
Restore service safely and consistently during a **Windows patch deployment failure** while preserving evidence and meeting incident, security, and change-control requirements.
