# Runbook: Azure Vm Unavailable

## Purpose
Restore service safely and consistently during a **Azure VM unavailable** while preserving evidence and meeting incident, security, and change-control requirements.
